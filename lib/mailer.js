...
module.exports = {
  ...
  sendResetPasswordEmail: async (email, token) => {
    ...
    const mailOptions = {
      ...
      html: `<p>Bonjour,</p><p>Merci de confirmer votre inscription en cliquant sur le lien suivant : <a href="${process.env.FRONT_URL}/user/reset-password/${token}">cliquez-ici</a></p>`,
    };
